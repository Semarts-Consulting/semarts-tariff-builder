...
| --- | --- | --- | --- | --- | --- | --- | --- |
| SCN-001 | Small two-class site | Validate a simpler residential/commercial network with fewer customer groups | PM plus Tariff Engine/QA | High | No | Yes | Fixture, calculation test, expected tariff schedule, reconciliation |
...
| SCN-005 | Non-recoverable cost element | Validate partial recovery and explain excluded/non-recoverable cost | PM plus Tariff Engine/QA | Medium | No | Yes | Fixture, calculation test, excluded cost explanation, reconciliation |
...
1. Add SCN-001 and SCN-005 first because they increase commercial confidence without introducing new tariff logic.
2. Add SCN-002 and SCN-003 next to test rate sensitivity.
3. Add SCN-004 if capacity tariffs are expected in near-term stakeholder review.
4. Add SCN-006 before external release readiness to prove validation behavior.
