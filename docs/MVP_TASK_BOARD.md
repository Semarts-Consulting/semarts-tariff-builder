...
| WB-005 Asset-cost allocation scenario review | QA plus Tariff Engine/Data Import/PM review | `docs/WB_005_ASSET_ALLOCATION_SCENARIO.md`, future scenario fixture docs/tests if approved | Asset chargeability and annual amount treatment decisions | Medium | Documentation-only proposal exists. Do not add a fixture until asset annual amount and chargeability methodology is approved. |
