...
| WB-005 Asset-cost allocation decision | QA plus Tariff Engine/Data Import/PM review | `docs/WB_005_ASSET_ALLOCATION_SCENARIO.md`, `docs/WB_005_ASSET_DECISION_PACK.md`, future scenario fixture docs/tests if approved | Owner decision on test-only pre-set annual asset amounts | Medium | Decision pack added. Recommended route is test-only fixture with pre-set annual asset amounts, no production asset valuation or contract changes. |
