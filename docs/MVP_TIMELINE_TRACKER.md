...
| MVP candidate review: stable calculation workflow, visible audit trace, outputs reconcile to recoverable cost base | Wed 24 Jun 2026 | In progress | Representative scenario validates reconciliation in automated test; manual demo path accepted; sign-off pack ready | User sign-off owner, PM support | On track | Review `docs/MVP_CANDIDATE_SIGNOFF.md` and decide accepted / accepted with limitations / fixes required |
