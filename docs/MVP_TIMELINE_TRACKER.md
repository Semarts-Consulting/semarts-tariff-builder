...
| --- | --- | --- | --- | --- | --- | --- |
| MVP validation pack prepared with representative scenario, reconciliation test, sign-off pack, and local checks passed | Mon 22 Jun 2026 | Complete | Local branch `codex/mvp-candidate-validation`; `docs/MVP_CANDIDATE_SIGNOFF.md`; `tests/mvp-candidate-scenario.test.ts`; lint, type-check, full tests, and build passed locally | PM / manager thread | On track | User to commit, push, and open PR |
| Commit, push, and PR for MVP validation pack | Mon 22 / Tue 23 Jun 2026 | In progress | Package files are ready locally but not yet confirmed committed or pushed | User, with PM handoff commands | On track | Run Git commands provided in handoff and share PR link |
| Merge validation pack into `main` | Tue 23 Jun 2026 | Not started | Awaiting PR creation and review | User / PM | On track | Merge after PR is open, mergeable, and checks are absent or green |
| Manual demo path check from inputs to allocation, calculation, audit trace, output, and reconciliation | Tue 23 Jun 2026 | Not started | Demo path not yet walked after validation pack merge | PM plus user | On track | After merge, run local app and follow demo checklist |
