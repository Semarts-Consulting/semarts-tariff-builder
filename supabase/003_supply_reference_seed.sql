...
insert into public.supply_reference_data_sets (
  ...
  review_status,
  extraction_status,
  time_of_use_review_status,
  losses_review_status,
...
set
  ...
  time_of_use_review_status = excluded.time_of_use_review_status,
  losses_review_status = excluded.losses_review_status,
  ...
  distribution_loss_factors = excluded.distribution_loss_factors;

update public.supply_reference_data_sets
set
  review_status = 'Partially reviewed',
  extraction_status = 'Not extracted',
  time_of_use_review_status = 'Pending review',
  losses_review_status = 'Pending review',
  ...
  distribution_loss_factors = '[]'::jsonb
